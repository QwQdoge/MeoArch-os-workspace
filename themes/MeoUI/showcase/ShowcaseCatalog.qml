    ...
    readonly property var categories: [
        ...
        },
        {
            ...
            "components": [
                ...
                component("Expressive buttons", "components/MeoButton.qml", "Button scale, bouncy press, vibrant fill, and emphasized type.", "xs/s/m/l/xl, square, round, bouncy, vibrant", "Bouncy, vibrant, emphasized, loading", "size, shape, bouncy, vibrant, isEmphasized", "MeoButton { text: \"Create\"; size: \"xl\"; vibrant: true }"),
