    ...
    readonly property var categories: [
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoMediaCard", "components/MeoMediaCard.qml", "Rich media container card supporting top/left/right media placement, aspect ratios, responsive sizing, and actions.", "s, m, l sizes, top, left, right media positions", "Default, interactive, hover, press, selected", "title, subtitle, supportingText, mediaSource, mediaAspectRatio, mediaPosition, avatarSource, avatarInitials, actions", "MeoMediaCard { title: \"Title\"; supportingText: \"Description\"; mediaSource: \"url\" }"),
