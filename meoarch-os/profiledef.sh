...
file_permissions=(
  ...
  ["/usr/lib/meoarch-repair/checks/audio.sh"]="0:0:755"
  ["/usr/lib/meoarch-repair/checks/display.sh"]="0:0:755"
  ...
  ["/usr/share/polkit-1/actions/org.meo.repair.policy"]="0:0:644"
  ["/usr/share/polkit-1/actions/org.meo.repair-live.policy"]="0:0:644"
  ["/usr/share/polkit-1/rules.d/49-meoarch-live-repair.rules"]="0:0:644"
  ["/usr/lib/meoarch-repair/live-actions/reload-systemd-manager.sh"]="0:0:755"
  ["/usr/lib/meoarch-repair/live-actions/restart-network-manager.sh"]="0:0:755"
  ["/usr/lib/meoarch-repair/live-actions/rebuild-initramfs.sh"]="0:0:755"
  ["/usr/lib/meoarch-repair/live-actions/refresh-pacman-keyring.sh"]="0:0:755"
  ["/usr/share/meoarch-repair/knowledge/manifest.json"]="0:0:644"
